...
* Hands-on lab guides in the [`labs/`](labs/) directory: objectives, step-by-step instructions, expected output, and exercises for every pattern.
...
├── labs/                # Hands-on lab guides (one per pattern)
