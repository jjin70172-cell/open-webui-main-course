<script lang="ts">
	...
	import HelpCircleIcon from '$lib/components/layout/Sidebar/icons/HelpCircle.svelte';
			...
			<div class="flex items-center w-full max-w-full">
				...
				<div class="mr-1 flex flex-none items-center gap-2 self-center">
					...
					<Tooltip content={$i18n.t('Help')}>
						...
						>
							<HelpCircleIcon className="size-4.5" strokeWidth="1.5" />
						</button>
					</Tooltip>
				</div>
			</div>
